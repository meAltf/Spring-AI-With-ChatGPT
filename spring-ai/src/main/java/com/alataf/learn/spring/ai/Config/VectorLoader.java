package com.alataf.learn.spring.ai.Config;
...
public class VectorLoader {
    ...
    SimpleVectorStore simpleVectorStore(EmbeddingModel embeddingModel) {
        ...
        File vectorStoreFile = new File("D:/Backend-Learning/Spring-AI-phase2/spring-ai/src/main/resources/Indian_Constitution.pdf/vector_store.json");
